...
const INPUT_FILE = "CV_WRITER_OUTREACH_BATCH_2026-05-29.csv";
const SENT_LOG_FILE = "CV_WRITER_OUTREACH_SENT_LOG_2026-05-29.csv";
...
async function main() {
  ...
  const limit = limitArg ? Number(limitArg.replace("--limit=", "")) : 8;
