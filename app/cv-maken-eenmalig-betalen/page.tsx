      ...
      <main className="mx-auto max-w-6xl px-6 py-10 pb-28 md:pb-10">
        ...
        <section className="mb-12 grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
          <article className="border-4 border-black bg-black p-6 text-white shadow-[6px_6px_0px_0px_rgba(250,204,21,1)]">
            ...
            <div className="mt-5 flex flex-wrap gap-3">
              <TrackedLandingLink
                ...
                trackingLocation="cv-maken-eenmalig-betalen:package_check_holiday_pay"
              ...
              <TrackedLandingLink
                ...
                trackingLocation="cv-maken-eenmalig-betalen:package_check_leave_days"
          ...
          <article className="border-4 border-black bg-white p-6 shadow-[5px_5px_0px_0px_rgba(0,0,0,1)]">
            <p className="text-xs font-black uppercase tracking-[0.2em] text-slate-600">
              Waarom dit op een money page hoort
            </p>
            <p className="mt-4 text-sm font-medium leading-relaxed text-slate-700">
              Prijs wordt geloofwaardiger als je ook de inhoudelijke context helpt uitklaren. Deze tools geven bezoekers een nuttige Belgische tussenstap in plaats van ze alleen sneller naar checkout te duwen.
            </p>
          </article>
        </section>
